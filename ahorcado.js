...
function pistaFunction(palabra){
    ...
    switch(palabra){  // Se crea un switch para poder controlar las pistas segun la palabra 
        case 'PELIGRO':   // Se debera hacer un case por cada palabra 
            pista = "Fuente situación o acto <P...>";
            break;     // Es importante el break en cada case 
        case 'EPP':
            pista = "Son la última barrera de protección";
            break;
        case 'CASCO':
...
function horca(errores){
    ...
    imagen.src = "../assets/ahorcado"+errores+".png";
